...
public abstract class ResourcesHandler
{
	 ...
	 * @throws PrintersServerException with an occurred exception
	 */
	public abstract void copyToDirectory(File paramFile) throws PrintersServerException;
	...
	protected void createFile(File destDir, InputStream inputStream, String filePathWithoutExtraInfo) throws PrintersServerException
	{
	...
	private void closeStream(FileOutputStream fileOutputStream) throws PrintersServerException
	{
	...
	protected void closeStream(InputStream inputStream) throws PrintersServerException
	{
		if (inputStream != null)
		{
			try
